        ...
        <template #header>
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Button :pt="ptButton" outlined
                    ...
                    label="Volver" @click="go(route('candidato.dashboard'))">
                    <template #icon>
                    ...
                    <div class="relative grid gap-6 lg:grid-cols-[1fr_340px] lg:items-center">
                        <div>
                            ...
                            <h1 class="max-w-3xl text-3xl font-black leading-tight tracking-tight sm:text-4xl">
                                Crea tu currículum para empezar a postularte.
                            </h1>

                            <p class="mt-4 max-w-2xl text-sm leading-7 text-slate-300">
                                Completa tu información profesional, experiencia, educación, habilidades e idiomas para
                                que el
                                equipo de reclutamiento pueda conocer mejor tu perfil.
                            </p>
                        </div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs leading-5 text-slate-300">
                                        Necesitas tener un currículum registrado para enviar aplicaciones a las ofertas.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <section class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
                    <div class="border-b border-slate-100 bg-slate-50 px-6 py-5">
                        ...
                        <p class="mt-1 text-sm text-slate-500">
                            Diligencia los campos necesarios para construir tu perfil profesional.
                        </p>
                    </div>

                    <div class="p-6">
                        <ResumeForm :model-value="empty" :levels="levels" :action="route('candidato.resume.store')"
                            method="post" submit-text="Crear currículum" />
                    </div>
                </section>
            </div>
        </div>
...
import { ptButton } from '@/primevue/pt';
